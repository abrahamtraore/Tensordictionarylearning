...
def Reconstruction(Originalimage,patchsize,Rank,alpha,theta,val,pool):
    ...
    adress='/Users/Traoreabraham/Desktop/OnlineTensorDictionaryLearning/Inpaintingproblem/ImageInpainting/Objectivefunctions/OnlinesingleObjectivefunctionnonegative'+str(Rank)
...
pool=Pool(20)
Imrestored,Listrestauration,listobjectivefunctionvalues,Objectivefunction_per_epoch=Reconstruction(Hyperspectralimgpixelsdropped,patchsize,Rank,alpha,theta,val,pool)
