...
#PSNR over different epochs for OTLunconstrained rank=4
PSNROTLsingleepochsoneunconstrained=np.array([9.7028,5.3156,10.9681,17.3701])
   
#PSNR over different epochs for OTL: rank=4
PSNROTLsingleepochsoneconstrained=np.array([14.5094,16.0967,19.1163,18.9457])
...
#PSNR over different epochs for OTLminibatch: rank=8
...
#f=plt.figure()
#plt.plot(Epochs,PSNROTLsingleepochsoneunconstrained,label="OTLsingle-unconstrained",color='blue',markersize=10,ls='--',marker='*')
#plt.plot(Epochs,PSNROTLsingleepochsoneconstrained,label="OTLsingle-nonnegative",color='red',markersize=10,ls='--',marker='H')
...
PSNROnlinesingleallrunsrank4=np.array([18.4470,18.2582,16.5849])
PSNROnlinesingleallrunsrank6=np.array([21.6905,19.9580,19.2907])
PSNROnlinesingleallrunsrank8=np.array([17.5480,21.1657,20.3039])
...
PSNROnlineAltoallrunsrank4=np.array([15.3650,17.1460,12.3174])
PSNROnlineAltoallrunsrank6=np.array([7.7517,4.89713])
PSNROnlineAltoallrunsrank8=np.array([16.7653,18.1968])
...
PSNRTuckerunconstrainedrunsrank4=np.array([17.9456,18.7032,17.0901])
PSNRTuckerunconstrainedrunsrank6=np.array([17.9456,18.7032,17.0901])
PSNRTuckerunconstrainedrunsrank8=np.array([17.9456,18.7032,17.0901])
...
PSNROnlinesingleunconstrainedrunsrank4=np.array([18.5123,16.6969,16.9071,14.6757,15.6304])
PSNROnlinesingleunconstrainedrunsrank6=np.array([20.6717,19.8356,19.3737,19.4760,21.2245])
PSNROnlinesingleunconstrainedrunsrank8=np.array([17.1982,23.0062,20.6840,19.9790,18.6617])
...
PSNROnlinesingle=np.array([np.mean(PSNROnlinesingleallrunsrank4),np.mean(PSNROnlinesingleallrunsrank6),np.mean(PSNROnlinesingleallrunsrank8),np.mean(PSNROnlinesingleallrunsrank10),np.mean(PSNROnlinesingleallrunsrank12),np.mean(PSNROnlinesingleallrunsrank14),np.mean(PSNROnlinesingleallrunsrank16),np.mean(PSNROnlinesingleallrunsrank18)])
PSNROnlineminibatch=np.array([np.mean(PSNROnlineminibatchallrunsrank10),np.mean(PSNROnlineminibatchallrunsrank12),np.mean(PSNROnlineminibatchallrunsrank14),np.mean(PSNROnlineminibatchallrunsrank16),np.mean(PSNROnlineminibatchallrunsrank18)])
PSNROnlineAlto=np.array([np.mean(PSNROnlineAltoallrunsrank4),np.mean(PSNROnlineAltoallrunsrank6),np.mean(PSNROnlineAltoallrunsrank8),np.mean(PSNROnlineAltoallrunsrank10),np.mean(PSNROnlineAltoallrunsrank12),np.mean(PSNROnlineAltoallrunsrank14),np.mean(PSNROnlineAltoallrunsrank16),np.mean(PSNROnlineAltoallrunsrank18)])
PSNRTuckerunconstrained=np.array([np.mean(PSNRTuckerunconstrainedrunsrank4),np.mean(PSNRTuckerunconstrainedrunsrank6),np.mean(PSNRTuckerunconstrainedrunsrank8),np.mean(PSNRTuckerunconstrainedrunsrank10),np.mean(PSNRTuckerunconstrainedrunsrank12),np.mean(PSNRTuckerunconstrainedrunsrank14),np.mean(PSNRTuckerunconstrainedrunsrank16),np.mean(PSNRTuckerunconstrainedrunsrank18)])
PSNROnlineminibatchunconstrained=np.array([np.mean(PSNROnlineminibatchunconstrainedrunsrank10),np.mean(PSNROnlineminibatchunconstrainedrunsrank12),np.mean(PSNROnlineminibatchunconstrainedrunsrank14),np.mean(PSNROnlineminibatchunconstrainedrunsrank16),np.mean(PSNROnlineminibatchunconstrainedrunsrank18)])
PSNROnlinesingleunconstrained=np.array([np.mean(PSNROnlinesingleunconstrainedrunsrank4),np.mean(PSNROnlinesingleunconstrainedrunsrank6),np.mean(PSNROnlinesingleunconstrainedrunsrank8),np.mean(PSNROnlinesingleunconstrainedrunsrank10),np.mean(PSNROnlinesingleunconstrainedrunsrank12),np.mean(PSNROnlinesingleunconstrainedrunsrank14),np.mean(PSNROnlinesingleunconstrainedrunsrank16),np.mean(PSNROnlinesingleunconstrainedrunsrank18)])

RunningtimeTuckerunconstrained=np.array([383.1632,405.1526,467.4013,1220.1145,1349.0846,1535.2267,1682.8704,2022.3015])#,2022.3015])
RunningtimeOnlinesingleunconstrained=np.array([11.43930,11.1813,11.3127,14.2687,15.0815,18.0477,17.2945,17.9043])
RunningtimeOnlineAlto=np.array([2.3665,2.9628,2.6861,3.5215,4.4491,2.8350,3.4161,2.69651])#,3.7070])
RunningtimeOnlinesingle=np.array([13.9171,15.0686,16.4004,17.7222,19.3673,20.3726,22.2948,22.5041])
...
ax.set_xticklabels([2*(i+2) for i in range(8)])
ax.set_ylim(0,40)
ax.set_ylabel('PSNR (dB)',fontsize=20)
plt.show()
f.savefig("PSNRMLSP.pdf")

Data=np.zeros((8,4))
Data[:,0]=RunningtimeTuckerunconstrained
Data[:,1]=RunningtimeOnlinesingleunconstrained 
Data[:,2]=RunningtimeOnlineAlto
Data[:,3]=RunningtimeOnlinesingle
f = plt.figure()
df2=pd.DataFrame(np.log(Data)/np.log(10), columns=['TuckerBatch-unconstrained','OTLsingle-unconstrained','ALTO','OTLsingle-nonnegative'])
ax=df2.plot(kind='bar',color=['blue','maroon' ,'green','magenta'],rot=0)#,yerr=Std.T)#.bar()
...
ax.set_xticklabels([2*(i+2) for i in range(8)])
ax.set_ylim(0,5)
ax.set_ylabel('Runningtime',fontsize=20)
plt.show()
f.savefig("RunningtimeMLSP.pdf")
